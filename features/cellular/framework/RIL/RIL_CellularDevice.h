...
public:
    ...
    virtual CellularContext *create_context(FileHandle *fh = NULL, const char *apn = NULL, bool cp_req = false,
                                            bool nonip_req = false);

#if (DEVICE_SERIAL && DEVICE_INTERRUPTIN)
    virtual CellularContext *create_context(UARTSerial *serial, const char *apn, PinName dcd_pin = NC,
                                            bool active_high = false, bool cp_req = false, bool nonip_req = false);
#endif
    ...
    nsapi_error_t lock_and_send_request(int request_id, void *data, size_t data_len,
                                        ...
                                        int timeout = CellularContext::DEVICE_TIMEOUT);
