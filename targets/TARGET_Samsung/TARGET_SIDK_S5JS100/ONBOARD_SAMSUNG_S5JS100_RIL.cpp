...
nsapi_error_t ONBOARD_SAMSUNG_S5JS100_RIL::hard_power_on()
{
    tr_info("Starting S5JS100 modem");
    s5js100_modem_start();
    return SAMSUNG_S5JS100_RIL::hard_power_on();
}

nsapi_error_t ONBOARD_SAMSUNG_S5JS100_RIL::hard_power_off()
{
    tr_info("Stopping S5JS100 modem");
    s5js100_modem_stop();
    return SAMSUNG_S5JS100_RIL::hard_power_off();
}
